...
public class FlightDAO {
    ...
    /**
     * Add a flight record into the database which matches the values contained in the flight object.
    ...
    /**
     * Update the flight identified by the flight id to the values contained in the flight object.
     *
     * You only need to change the sql String and set preparedStatement parameters.
     *
    ...
    public void updateFlight(int id, Flight flight){
        ...
        try {
            //Write SQL logic here
            //String sql = "UPDATE flight SET flight_id = (?), departure_city = (?), arrival_city = (?)";
